...
describe 'cassandra::server' do # rubocop:disable RSpec/DescribeClass
  ...
  it 'downloads cassandra tarball' do
    expect(chef_run).to create_remote_file_if_missing('/usr/src/cassandra-20130603180240.tar.gz')
  end
